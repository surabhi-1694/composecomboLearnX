...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>coilImageCompose</b> with <b>io.coil-kt.coil3:coil-compose</b> coordinates and
     * with version reference <b>coilVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getCoilImageCompose() {
        return create("coilImageCompose");
    }

    /**
     * Dependency provider for <b>coilImageNetwork</b> with <b>io.coil-kt.coil3:coil-network-okhttp</b> coordinates and
     * with version reference <b>coilVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getCoilImageNetwork() {
        return create("coilImageNetwork");
    }
    ...
    /**
     * Dependency provider for <b>newsApi</b> with <b>com.github.KwabenBerko:News-API-Java</b> coordinates and
     * with version reference <b>newsAPIVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getNewsApi() {
        return create("newsApi");
    }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>androidx.livedata</b>
         */
        public AndroidxLivedataLibraryAccessors getLivedata() {
    ...
    public static class AndroidxLivedataLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compose</b> with <b>androidx.compose.runtime:runtime-livedata</b> coordinates and
         * with version reference <b>runtimeCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("androidx.livedata.compose");
        }
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>serialize</b> with <b>org.jetbrains.kotlinx:kotlinx-serialization-json</b> coordinates and
         * with version reference <b>kotlinserialize</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSerialize() {
            return create("kotlin.serialize");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coilVersion</b> with value <b>3.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinCompose</b> with value <b>1.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinSerializeplugin</b> with value <b>1.5.21</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinSerializeplugin() { return getVersion("kotlinSerializeplugin"); }

        /**
         * Version alias <b>kotlinserialize</b> with value <b>1.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinserialize() { return getVersion("kotlinserialize"); }
        ...
        /**
         * Version alias <b>lifecycleViewmoelCompose</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLifecycleViewmoelCompose() { return getVersion("lifecycleViewmoelCompose"); }
        ...
        /**
         * Version alias <b>newsAPIVersion</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNewsAPIVersion() { return getVersion("newsAPIVersion"); }
        ...
        /**
         * Version alias <b>runtimeCompose</b> with value <b>1.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRuntimeCompose() { return getVersion("runtimeCompose"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>kotlinSerializable</b> with plugin id <b>org.jetbrains.kotlin.plugin.serialization</b> and
         * with version reference <b>kotlinSerializeplugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlinSerializable() { return createPlugin("kotlinSerializable"); }
