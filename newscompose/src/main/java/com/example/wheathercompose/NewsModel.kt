...
class NewsModel : ViewModel() {
    ...
    * */
    private var _topNewsResultMutableStateFlow =
        MutableStateFlow<NetworkResponse<TopNews?>>(NetworkResponse.Loading)
    var topNewsResultStateFlow: StateFlow<NetworkResponse<TopNews?>> =
        _topNewsResultMutableStateFlow
