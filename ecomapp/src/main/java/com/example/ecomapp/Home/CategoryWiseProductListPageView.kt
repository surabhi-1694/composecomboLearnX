...
fun CategoryWiseProductListPageView(categoryId:String, authViewModel: AuthViewModel = viewModel()){
    ...
    val productList = remember {
        mutableStateOf<List<CategoryWiseProduct>>(emptyList())
    }
...
//            productList.value =  authViewModel.getCategoriesListwise(categoryId)
            val catWiseProductList : List<CategoryWiseProduct> = authViewModel.getCategoryWiseProduct(categoryId).mapNotNull { doc ->
